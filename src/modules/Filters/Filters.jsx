	...
	return (
		<div className={styles._}>
			<div className={styles.registration}>
				<Input title='Дата оформления' placeholder='Введите' prevText='с' value='20.01.2021' />
				<Input placeholder='Введите' prevText='по' />
			</div>
			<div className={styles.orderStatus}>
				<Input title='Статус заказа' value='Новый' inputStates='multiple' />
			...
			<div className={styles.amount}>
				<Input title='Сумма заказа' placeholder='Введите' prevText='от' value='5000' />

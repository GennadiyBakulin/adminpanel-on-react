...
export const TableHeader = () => {
	...
	return (
		<div className={styles._}>
			<TableCell className={styles.checkboxCell} name={tableHead.checkField.name}>
				<Checkbox />
			</TableCell>
			...
			<TableCell className={styles.statusCell} name={tableHead.statusField.name}>
				{tableHead.statusField.text}
				<Icon className={styles.icon} name='v_arrow' />
			</TableCell>
			<TableCell className={styles.positionCell} name={tableHead.positionField.name}>
				{tableHead.positionField.text}
				<Icon className={styles.icon} name='v_arrow' />
			</TableCell>
			<TableCell className={styles.amountCell} name={tableHead.amountField.name}>
				{tableHead.amountField.text}
				<Icon className={styles.icon} name='v_arrow' />
			</TableCell>
			<TableCell className={styles.nameCell} name={tableHead.personNameField.name}>
